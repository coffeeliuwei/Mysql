...
public class SqlReflect
{
	...
	public static Method findGetter(Class<? extends Object> clazz, String field)
	{
		return getMethod(clazz, getter(field));
	}
	public static Method findSetter(Class<? extends Object> clazz, String field)
	{
	 ...
	 */
	public static Object typedValue(SqlContext c, int type, String value)
	{
